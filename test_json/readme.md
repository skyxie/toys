...
Consider the consequences if we wanted to change class A in our example. Suppose we want to add a 3rd optional argument that's an object of a new class B. In that case, the JSON text should look like:
